...
echo -n $'\E[33m' "Instalando paquetes ..."; apt-get install -y x11vnc xvfb libxcursor1 ca-certificates bzip2 libnss3 libegl1-mesa x11-xkb-utils libasound2 libglib2.0-0 python nano screen zip > /dev/null; echo $'\E[32m' " Completado.";
