...
apt-get install -y x11vnc xvfb libxcursor1 ca-certificates curl bzip2 libnss3 libegl1-mesa x11-xkb-utils libasound2 libpci3 libxslt1.1 libxkbcommon0 libxss1 libxcomposite1 libglib2.0-0 python nano screen zip >> script.log 2>&1
...
echo -n $'\E[30m' "222222222222222222";echo -n $'\E[36m' "Intervenir      Intervenir q enter y enter";echo
