...
echo -n $'\E[33m' "Descargando TS3 ..."; wget -q http://dl.4players.de/ts/releases/3.5.6/TeamSpeak3-Client-linux_amd64-3.5.6.run > /dev/null; echo $'\E[32m' " Completado.";

chmod 0755 TeamSpeak3-Client-linux_amd64-3.5.6.run > /dev/null;
echo $'\E[30m' "______________________________________________________";
echo -n $'\E[31m' "Accion requerida!, presione(Q, Enter, Y, Enter)"; echo $'\E[30m' " Completado."; ./TeamSpeak3-Client-linux_amd64-3.5.6.run > /dev/null;
echo $'\E[30m' "....";
